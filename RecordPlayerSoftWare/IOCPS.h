...
#define MINIMUMPACKAGESIZE  PACK_HEAD_LENGTH  //一个包的最小长度是8个字节
#define MAXIMUMPACKAGESIZE  MAX_PACKAGE+PACK_HEAD_LENGTH //包最大长度
#define MAXIMUMSEQUENSENUMBER 5001
#define MAXIMUMPAYLOADSIZE MAXIMUMPACKAGESIZE-MINIMUMPACKAGESIZE  //最大负载
...
private: 
	...
	// Process received Packages :该函数需要根据协议包进行解包
	...
	SOCKET					m_socListen;   
	// Tr錮en som lyssnar p?connections 
