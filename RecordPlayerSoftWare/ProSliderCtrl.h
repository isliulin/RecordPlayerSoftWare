...
protected:
	...
	void DrawCircle(CDC *pDC, CRect rc, COLORREF nClr, BOOL First=FALSE);
	void RecursiveRect(CDC *pDC, CRect rc, COLORREF nClr, BOOL First=FALSE);
	void RecursiveChannel(CDC *pDC, CRect rc, COLORREF nClr,
		BOOL First=FALSE, BOOL Vertical=FALSE,BYTE StepSize=0);
	void RecursiveBorder(CDC *pDC, CRect rc, COLORREF nClr,
		BOOL First=FALSE, BOOL Vertical=FALSE,BYTE StepSize=0);
