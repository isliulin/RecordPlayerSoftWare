...
#include "resource.h"
#include "GlobalVF.h"       //全局类



#include "./skin/SkinMagicLib.h"
#include <afxdlgs.h>
#pragma comment(lib,"./skin/SkinMagic.lib")
...
#ifdef _DEBUG
#pragma comment(lib,"./SQLite3/SQLiteWrapperD.lib");
#else
#pragma comment(lib,"./SQLite3/SQLiteWrapper.lib");
#endif
...
extern CGlobalVF m_gGlobalVF; //全局类
