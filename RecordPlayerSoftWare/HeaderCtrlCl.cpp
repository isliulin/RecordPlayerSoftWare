...
void CHeaderCtrlCl::SetSortArrow( const int nSortColumn, const BOOL bDesc )
{
...
inline int	 CHeaderCtrlCl::GetCrntSortCol() const
{
	return m_iSortColumn;
}

inline BOOL CHeaderCtrlCl::GetCrntSortDirection() const
{
	return m_bSortDesc;
}